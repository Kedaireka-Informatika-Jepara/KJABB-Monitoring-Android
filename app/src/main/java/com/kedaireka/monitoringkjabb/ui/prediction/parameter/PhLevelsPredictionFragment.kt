...
import com.kedaireka.monitoringkjabb.databinding.FragmentPhLevelsPredictionBinding
 ...
 * Use the [PhLevelsPredictionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PhLevelsPredictionFragment : Fragment() {
    private lateinit var phLevelFragmentViewModel: PhLevelsPredictionFragmentViewModel
    private lateinit var recordsInRange: ArrayList<Sensor>

    private var _binding: FragmentPhLevelsPredictionBinding? = null
    ...
    override fun onCreateView(
        ...
        phLevelFragmentViewModel = ViewModelProvider(this)[PhLevelsPredictionFragmentViewModel::class.java]

        _binding = FragmentPhLevelsPredictionBinding.inflate(inflater, container, false)
