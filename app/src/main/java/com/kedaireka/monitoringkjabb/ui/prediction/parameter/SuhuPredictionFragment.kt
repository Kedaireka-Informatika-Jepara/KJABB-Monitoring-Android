...
import com.kedaireka.monitoringkjabb.databinding.FragmentSuhuPredictionBinding
...
import com.kedaireka.monitoringkjabb.ui.statistics.parameter.WaterTemperatureFragmentViewModel
 ...
 * Use the [SuhuPredictionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SuhuPredictionFragment : Fragment() {

    private lateinit var waterTemperatureFragmentViewModel: SuhuPredictionFragmentViewModel
    private lateinit var recordsInRange: ArrayList<Sensor>

    private var _binding: FragmentSuhuPredictionBinding? = null
    ...
    override fun onCreateView(
        ...
        waterTemperatureFragmentViewModel =
            ViewModelProvider(this)[SuhuPredictionFragmentViewModel::class.java]

        _binding = FragmentSuhuPredictionBinding.inflate(inflater, container, false)
