 ...
 * Use the [AmmoniaPredictionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AmmoniaPredictionFragment : Fragment() {

    private lateinit var ammoniaFragmentViewModel: AmmoniaPredictionFragmentViewModel
    private lateinit var recordsInRange: ArrayList<Sensor>

    private var _binding: FragmentAmmoniaPredictionBinding? = null
    ...
    override fun onCreateView(
        ...
        ammoniaFragmentViewModel = ViewModelProvider(this)[AmmoniaPredictionFragmentViewModel::class.java]

        _binding = FragmentAmmoniaPredictionBinding.inflate(inflater, container, false)
